...
# Retrieve and display the current user's name
user_name = get_current_user_name()
if user_name:
    st.write(f"Current User: {user_name}")

st.header("Enter your name for a personalized experience with the app.")
...
st.write("Check the current WiFi settings in the list below")
